...
PRINTF("diff ");
	...
	/* Le gradient du bord droite est négatif */
...
/*
Calcule le defilement du bord selon les configurations
 */
...
#ifndef IMG_PROC_TEST
#define IMG_PROC_TEST 0
#endif
